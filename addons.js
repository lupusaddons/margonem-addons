(function() {
    ...
    const allowedUsers = ['5676978', '6901372', '9449685', '1406394', '9839862', '6680459', '829797', '6581687', '251614', '7949481', '1909323', '1193100', '9682982', '6591109', '5261188', '2221811', '4116980', '5942859', '9434153', '6145947', '9848909', '9550217', '9376321', '6283400', '583750', '4672322', '9085663', '7736753', '7712777', '6505636', '6555412', '3155337', '7466726', '6464617', '5090092', '9923077', '7246870', '8170184', '8631058', '6110079', '3449240', '7443491', '9794893', '9803001', '7617868', '8228619', '9668158', '5630085', '9442821', '5906841', '6580761', '5801771', '9604384', '9975302', '9285345', '6558282', '8320962', '8889608', '8776354', '9181569', '5641911', '6719921', '6770292', '8986880', '6873278', '4217774', '5365202', '1763767', '8797715', '6036183', '9710930', '8187398', '9153488', '4540634', '5158011']; // <-- Tutaj wklej swoje ID
...
(function() {
	...
	window.playerGuilds = window.playerGuilds || {};
    const playerGuilds = window.playerGuilds;
	let observedGuilds = [];
...
checkboxContainer.addEventListener('wheel', (e) => {
    ...
    try {
        // Wykonaj kod scrapera - playerGuilds jest już dostępne globalnie
        eval(code);
...
players.filter(p => {
    ...
    if (currentFilter === 'selected-guilds') {
        const selectedGuilds = getSelectedGuilds();
        if (selectedGuilds.length === 0) return true; // Jeśli brak wybranych klanów, pokaż wszystkich
        const playerGuild = getPlayerGuild(p.n);
        // Pokaż graczy z wybranych klanów ORAZ graczy bez klanu
    ...
    if (currentFilter.startsWith('guild:')) {
        ...
        const playerGuild = getPlayerGuild(p.n);
        // Dla konkretnego klanu pokaż tylko graczy z tego klanu (bez graczy bez klanu)
